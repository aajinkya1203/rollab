        ...
        <div>
            <div className="section row" style={{
                ...
                <div className="container introSection col s12">
                    ...
                    <Floating />
                    <h2 className="header col s12 l3 offset-l2 center rollabTitle">
                        Introducing rollab
                    </h2>
                ...
                >
                    <path fill="#ffffff"           
                    d="M0,0L48,10.7C96,21,192,43,288,53.3C384,64,480,64,576,85.3C672,107,768,149,864,165.3C960,181,1056,171,1152,186.7C1248,203,1344,245,1392,266.7L1440,288L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z" />
                </svg>
            </div>
            {/* parallax effect */}
